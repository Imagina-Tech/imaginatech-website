...
// ===========================
// NOTA DE SEGURANCA: Estas funcoes sao expostas globalmente porque sao chamadas
// por onclick handlers em HTML gerado dinamicamente (service cards, modals, etc.)
// Futuro refactoring: migrar para data-action e event delegation
//
// Organizadas no namespace window.IT para reduzir poluicao do objeto window global

window.IT = window.IT || {};

// Autenticacao
window.IT.signIn = signInWithGoogle;
window.IT.signOut = signOut;

// Modais
window.IT.openAddModal = openAddModal;
window.IT.closeServiceTypeModal = closeServiceTypeModal;
window.IT.selectServiceType = selectServiceType;
window.IT.openEditModal = openEditModal;
window.IT.closeModal = closeModal;
window.IT.closeStatusModal = closeStatusModal;
window.IT.closeTrackingModal = closeTrackingModal;
window.IT.closeDeliveryModal = closeDeliveryModal;
window.IT.closeFilesModal = closeFilesModal;
window.IT.closeImageModal = closeImageModal;

// Servicos
window.IT.saveService = saveService;
window.IT.deleteService = deleteService;
window.IT.updateStatus = updateStatus;
window.IT.confirmStatusChange = confirmStatusChange;
window.IT.filterServices = filterServices;

// Tracking
window.IT.showTrackingCodeModal = showTrackingCodeModal;
window.IT.confirmTrackingCode = confirmTrackingCode;

// Arquivos e Imagens
window.IT.handleFileSelect = handleFileSelect;
window.IT.handleImageSelect = handleImageSelect;
window.IT.removePreviewImage = removePreviewImage;
window.IT.removeFilePreview = removeFilePreview;
window.IT.removeFile = removeFile;
window.IT.downloadFile = downloadFile;
window.IT.showServiceImages = showServiceImages;
window.IT.showServiceFiles = showServiceFiles;
window.IT.prevImage = prevImage;
window.IT.nextImage = nextImage;

// Cliente
window.IT.contactClient = contactClient;
window.IT.handleClientNameInput = handleClientNameInput;
window.IT.selectClient = selectClient;
window.IT.copyToClipboard = copyToClipboard;

// Portfolio
window.IT.openUpModal = openUpModal;
window.IT.closeUpModal = closeUpModal;
window.IT.showUpForm = showUpForm;
window.IT.toggleCategoryField = toggleCategoryField;
window.IT.handleUpPhotoSelect = handleUpPhotoSelect;
window.IT.removeUpPhoto = removeUpPhoto;
window.IT.handleUpLogoSelect = handleUpLogoSelect;
window.IT.removeUpLogo = removeUpLogo;
window.IT.saveToPortfolio = saveToPortfolio;
window.IT.removeExtraPhoto = removeExtraPhoto;

// COMPATIBILIDADE: Aliases no window global para codigo legado
// TODO: Migrar onclick handlers para usar window.IT.* ou data-action
