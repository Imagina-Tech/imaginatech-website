/*
==================================================
ARQUIVO: /shared/custom-select.js
MODULO: Dropdown Customizado com Glassmorphism
SISTEMA: ImaginaTech - Gestao de Impressao 3D
VERSAO: 2.0 - Centralizado em /shared

Usado por: estoque, marketplace, servicos, financas, custo, admin-portfolio
Requer: /shared/custom-select.css

IMPORTANTE: Ao popular opcoes dinamicamente (innerHTML), usar setTimeout(0)
antes de definir .value para permitir que MutationObserver processe.
==================================================
*/
